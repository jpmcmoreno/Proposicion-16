...
def cargar_pasos_excel():
    ...
    try:
        return pd.read_excel("https://raw.githubusercontent.com/jpmcmoreno/Proposicion-16/main/pruebaV2.xlsx")
    except:
        return pd.DataFrame({
            'paso': [1, 2, 3, 4],
            'descripcion': [
...
proposiciones_euclides = pd.read_excel("https://raw.githubusercontent.com/jpmcmoreno/Proposicion-16/main/proposiciones_euclides.xlsx")
