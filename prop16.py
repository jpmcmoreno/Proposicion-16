...
def cargar_pasos_excel():
    ...
    try:
        return pd.read_excel("C:/Users/jpmcm/OneDrive/Escritorio/Proposicion 16 aplicación/pruebaV2.xlsx")
    except:
        return pd.DataFrame({
            'paso': [1, 2, 3, 4],
            'descripcion': [
...
proposiciones_euclides = pd.read_excel('C:/Users/jpmcm/OneDrive/Escritorio/Proposicion 16 aplicación/proposiciones_euclides.xlsx')
